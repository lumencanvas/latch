...
import { equalizerExecutor } from '@/engine/executors/debug'
...
const definition: NodeDefinition = {
  ...
  tags: ['equalizer', 'spectrum', 'fft', 'frequency', 'analyzer', 'bands', 'audio reactive', 'visualizer'],
  info: {
...
export default defineNode({ definition, executor: equalizerExecutor })
